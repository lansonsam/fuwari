...
export const siteConfig: SiteConfig = {
	...
	favicon: [
		...
		{
			src: "https://q2.qlogo.cn/headimg_dl?dst_uin=2952678374&spec=0", // Path of the favicon, relative to the /public directory
...
export const profileConfig: ProfileConfig = {
	avatar: "https://q2.qlogo.cn/headimg_dl?dst_uin=2952678374&spec=0", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
	name: "lansonsam",
	bio: "加载中...",
	links: [
		{
			...
			url: "mailto:lansonsam@nuiziyyds.com",
		},
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/lansonsam",
		},
		{
			name: "Steam",
			icon: "fa6-brands:steam",
			url: "https://steamcommunity.com/profiles/76561198862773271",
		},
	],
};
...
export const umamiConfig: UmamiConfig = {
	enable: true,
	baseUrl: "https://api.nuiziyyds.com",
	shareId: "8LG7Wn20Jc28yDA3",
