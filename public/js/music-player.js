...
window.MusicPlayerTitle = "Music Player"; // 音乐播放器标题/默认艺术家名称（当文件名无"-"时使用）
window.MusicPlayerAPIUrl = "https://music.588945.xyz/api/music/list"; // 音乐列表API地址
window.MusicPlayerDefaultVolume = 0.3; // 默认音量（范围：0-1）

// GitHub 链接配置
window.MusicPlayerGitHubUrl = false; // GitHub仓库链接（留空或false则不显示图标）
